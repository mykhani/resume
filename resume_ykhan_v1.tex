...
\project{STM32RTOS:}
        {My personal project of creating an RTOS from scratch for STM32 series ARM Cortex M4 microcontrollers. See https://github.com/mykhani/STM32RTOS for details and the features implemented so far (priority based scheduling, build system).}
